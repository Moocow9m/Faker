...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetNameFormats = ['{{streetPrefix}} {{lastName}}', '{{streetPrefix}} {{firstName}} {{lastName}}', '{{streetPrefix}} St. {{firstName}} {{lastName}}', '{{streetPrefix}} São. {{firstName}}', '{{streetPrefix}} de {{lastName}}'];

    protected static $streetAddressFormats = ['{{streetName}}', '{{streetName}}, {{buildingNumber}}', '{{streetName}}, {{buildingNumber}}, {{secondaryAddress}}'];
