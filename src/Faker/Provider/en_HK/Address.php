...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetNameFormats = ['{{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{syllable}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{direction}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{syllable}} {{direction}} {{streetSuffix}}', '{{syllable}} {{syllable}} {{streetSuffix}} {{direction}}', '{{syllable}} {{syllable}} {{syllable}} {{streetSuffix}} {{direction}}', '{{englishStreetName}} {{streetSuffix}}', '{{englishStreetName}} {{streetSuffix}} {{direction}}'];

    protected static $englishStreetNames = ["King's", "Queen's", "Nathan", "Robinson", "Kingston", "Irving", "Bonham", "Salisbury", "Tonkin", "Nanking", "Peking", "Canton", "Amoy", "Shanghai"];

    protected static $streetSuffix = ['Road', 'Road', 'Road', 'Street', 'Street', 'Street', 'Lane', 'Circuit', 'Avenue', 'Path', 'Square'];

    protected static $directions = ['North', 'East', 'South', 'West'];

    protected static $cities = ['Hong Kong', 'Kowloon', 'New Territories'];

    protected static $towns = ['{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', '{{syllable}} {{syllable}} {{syllable}}', 'Aberdeen', 'Stanley', 'Victoria'];
