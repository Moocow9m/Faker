...
{
    protected static $cityPrefix = ['เมือง', 'หมู่บ้าน', 'ท่า'];

    protected static $citySuffix = ['เหนือ', 'ใต้', 'บุรี'];

    protected static $buildingNumber = ['#####', '####', '###', '##', '##/###'];

    protected static $streetPrefix = ['ซอย', 'ถนน', 'สะพาน', 'วงเวียน', 'แยก'];
    ...
    protected static $streetNameFormats = ['{{streetPrefix}} {{streetSuffix}}'];
