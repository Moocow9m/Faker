...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetSuffixLong = ['Gasse', 'Platz', 'Ring', 'Straße', 'Weg'];
    protected static $streetSuffixShort = ['gasse', 'platz', 'ring', 'straße', 'weg'];
