...
class Internet extends \Faker\Provider\Internet
{
    ...
    protected static $safeEmailTld = ['com', 'kr', 'me', 'net', 'org'];

    protected static $tld = ['biz', 'com', 'info', 'kr', 'net', 'org'];
     ...
     */
    protected static $lastNameAscii = ['ahn', 'bae', 'baek', 'chang', 'cheon', 'cho', 'choi', 'chung', 'gang', 'go', 'gwak', 'gwon', 'ha', 'han', 'heo', 'hong', 'hwang', 'jang', 'jeon', 'jo', 'jung', 'kang', 'kim', 'ko', 'kwak', 'kwon', 'lee', 'lim', 'moon', 'nam', 'no', 'oh', 'park', 'ryu', 'seo', 'shim', 'shin', 'son', 'song', 'yang', 'yoon', 'yu'];
