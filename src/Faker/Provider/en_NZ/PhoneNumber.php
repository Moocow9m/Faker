...
class PhoneNumber extends \Faker\Provider\PhoneNumber
{
     ...
     * @var array
     */
    protected static $tollFreeFormats = ['0508######', '0508 ######', '0508 ### ###', '0800######', '0800 ######', '0800 ### ###'];

    /**
     * An array of en_NZ landline area codes
     * @var array
     */
    protected static $areaCodes = ['02', '03', '04', '06', '07', '09'];

    /**
     * An array of en_NZ landline beginning numbers
     * @var array
     */
    protected static $beginningNumbers = ['2', '3', '4', '5', '6', '7', '8', '9'];
