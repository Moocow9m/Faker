...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $state = ['Australian Capital Territory', 'New South Wales', 'Northern Territory', 'Queensland', 'South Australia', 'Tasmania', 'Victoria', 'Western Australia'];

    protected static $stateAbbr = ['ACT', 'NSW', 'NT', 'QLD', 'SA', 'TAS', 'VIC', 'WA'];

    protected static $streetAddressFormats = ['{{buildingNumber}} {{streetName}}', '{{buildingNumber}}{{buildingLetter}} {{streetName}}', '{{secondaryAddress}} {{buildingNumber}} {{streetName}}'];

    protected static $secondaryAddressFormats = ['Apt. ###', 'Flat ##', 'Suite ###', 'Unit ##', 'Level #', '### /', '## /', '# /'];
