...
{
    protected static $cityFormats = ['{{capital}}', '{{capital}}', '{{capital}}', '{{bigCity}}', '{{bigCity}}', '{{smallerCity}}'];
    protected static $streetNameFormats = ['{{firstName}} {{streetSuffix}}', '{{lastName}} {{streetSuffix}}'];
    protected static $streetAddressFormats = ['{{streetName}} {{buildingNumber}}.', '{{streetName}} {{buildingNumber}}. {{secondaryAddress}}'];
    protected static $addressFormats = ["{{postcode}} {{city}}, {{streetAddress}}"];
    ...
    {
        return ['latitude' => static::latitude(46.262740, 47.564721), 'longitude' => static::longitude(17.077949, 20.604560)];
    }
}
