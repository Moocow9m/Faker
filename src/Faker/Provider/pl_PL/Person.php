...
class Person extends \Faker\Provider\Person
{
    ...
    public static function taxpayerIdentificationNumber()
    {
        ...
        $result = [];
        do {
            $result = [static::randomDigitNotNull(), static::randomDigitNotNull(), static::randomDigitNotNull(), static::randomDigit(), static::randomDigit(), static::randomDigit(), static::randomDigit(), static::randomDigit(), static::randomDigit()];
            $checksum = 0;
