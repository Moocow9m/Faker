...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $cityFormats = ['{{lastName}}{{citySuffix}}'];
    protected static $streetNameFormats = ['{{lastName}}{{streetSuffix}}'];
    protected static $streetAddressFormats = ['{{streetName}}{{lastName}}{{areaNumber}}-{{areaNumber}}-{{areaNumber}}'];
    protected static $addressFormats = ['{{postcode}}  {{prefecture}}{{city}}{{ward}}{{streetAddress}}', '{{postcode}}  {{prefecture}}{{city}}{{ward}}{{streetAddress}} {{secondaryAddress}}'];
    protected static $secondaryAddressFormats = ['ハイツ{{lastName}}{{buildingNumber}}号', 'コーポ{{lastName}}{{buildingNumber}}号'];
