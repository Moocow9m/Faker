...
class Internet extends \Faker\Provider\Internet
{
    ...
    protected static $safeEmailTld = ['org', 'com', 'net', 'jp', 'jp', 'jp'];

    protected static $freeEmailDomain = ['gmail.com', 'yahoo.co.jp', 'hotmail.co.jp', 'mail.goo.ne.jp'];

    protected static $tld = ['com', 'com', 'com', 'biz', 'info', 'net', 'org', 'jp', 'jp', 'jp'];
     ...
     */
    protected static $lastNameAscii = ['aota', 'aoyama', 'ishida', 'idaka', 'ito', 'uno', 'ekoda', 'ogaki', 'kato', 'kanou', 'kijima', 'kimura', 'kiriyama', 'kudo', 'koizumi', 'kobayashi', 'kondo', 'saito', 'sakamoto', 'sasaki', 'sato', 'sasada', 'suzuki', 'sugiyama', 'takahashi', 'tanaka', 'tanabe', 'tsuda', 'nakajima', 'nakamura', 'nagisa', 'nakatsugawa', 'nishinosono', 'nomura', 'harada', 'hamada', 'hirokawa', 'fujimoto', 'matsumoto', 'miyake', 'miyazawa', 'murayama', 'yamagishi', 'yamaguchi', 'yamada', 'yamamoto', 'yoshida', 'yoshimoto', 'wakamatsu', 'watanabe'];
