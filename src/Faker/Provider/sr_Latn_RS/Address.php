...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = ['Bulevar'];

    protected static $street = ['Kralja Milana', 'Cara Dušana', 'Nikole Tesle', 'Mihajla Pupina', 'Nikole Pašića'];

    protected static $streetNameFormats = ['{{street}}', '{{streetPrefix}} {{street}}'];
