...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static $addressFormats = ['{{streetAddress}}, {{township}}, {{townState}}'];

    protected static $streetAddressFormats = ['{{buildingPrefix}}{{buildingNumber}}, {{streetName}}'];

    /**
     * Most of the time 'No.' is not needed, and 'Lot' is less used.
     */
    protected static $buildingPrefix = ['', '', '', '', '', '', 'No. ', 'No. ', 'No. ', 'Lot '];

    protected static $buildingNumber = ['%', '%', '%', '%#', '%#', '%#', '%#', '%##', '%-%', '?-##-##', '%?-##'];

    protected static $streetNameFormats = ['{{streetPrefix}} %', '{{streetPrefix}} %/%', '{{streetPrefix}} %/%#', '{{streetPrefix}} %/%?', '{{streetPrefix}} %/%#?', '{{streetPrefix}} %?', '{{streetPrefix}} %#?', '{{streetPrefix}} {{streetSuffix}}', '{{streetPrefix}} {{streetSuffix}} %', '{{streetPrefix}} {{streetSuffix}} %/%', '{{streetPrefix}} {{streetSuffix}} %/%#', '{{streetPrefix}} {{streetSuffix}} %/%?', '{{streetPrefix}} {{streetSuffix}} %/%#?', '{{streetPrefix}} {{streetSuffix}} %?', '{{streetPrefix}} {{streetSuffix}} %#?'];

    protected static $townshipFormats = ['{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefix}} {{townshipSuffix}}', '{{townshipPrefixAbbr}}%', '{{townshipPrefixAbbr}}%#', '{{townshipPrefixAbbr}}%#?'];
     ...
     */
    protected static $streetPrefix = ['Jln', 'Jln', 'Jalan', 'Jalan', 'Jalan', 'Lorong'];
     ...
     */
    protected static $townshipPrefixAbbr = ['SS', 'Seksyen ', 'PJS', 'PJU', 'USJ '];
    ...
    public static function postcode($state = null)
    {
        $format = ['perlis' => [
            ...
            // (25000 - 28800 | 39000 - 39200 | 49000, 69000)
            mt_rand(25000, 28800),
            mt_rand(39000, 39200),
            mt_rand(49000, 69000),
        ], 'perak' => [
