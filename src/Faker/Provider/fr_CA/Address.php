...
class Address extends \Faker\Provider\fr_FR\Address
{
     ...
     */
    protected static $cityFormats = ['{{cityPrefix}}{{firstName}}{{citySuffix}}', '{{cityPrefix}}{{firstName}}'];

    protected static $buildingNumber = ['#####', '####', '###', '##', '#'];

    protected static $streetSuffix = ['Autoroute', 'Avenue', 'Boulevard', 'Chemin', 'Route', 'Rue', 'Pont'];
     ...
     */
    protected static $streetNameFormats = ['{{streetSuffix}} {{firstName}}', '{{streetSuffix}} {{lastName}}'];

    protected static $streetAddressFormats = ['{{buildingNumber}} {{streetName}}', '{{buildingNumber}} {{streetName}} {{secondaryAddress}}'];

    protected static $addressFormats = ["{{streetAddress}}, {{city}}, {{stateAbbr}} {{postcode}}"];

    protected static $secondaryAddressFormats = ['Apt. ###', 'Suite ###', 'Bureau ###'];

    protected static $state = ['Alberta', 'Colombie-Britannique', 'Manitoba', 'Nouveau-Brunswick', 'Terre-Neuve-et-Labrador', 'Nouvelle-Écosse', 'Ontario', 'Île-du-Prince-Édouard', 'Québec', 'Saskatchewan'];

    protected static $stateAbbr = ['AB', 'BC', 'MB', 'NB', 'NL', 'NS', 'ON', 'PE', 'QC', 'SK'];
