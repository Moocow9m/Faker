...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetSuffix = ['Sokak', 'Caddesi', 'Kavşağı', 'Durağı', 'İş Hanı', 'Mevkii'];
