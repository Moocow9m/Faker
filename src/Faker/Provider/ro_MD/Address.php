...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = ['Str.', 'B-dul.', 'Aleea', 'Calea', 'P-ța', 'Str-la'];
    ...
    protected static $addressFormats = ["{{streetAddress}}, {{city}}, CP {{postcode}}"];
