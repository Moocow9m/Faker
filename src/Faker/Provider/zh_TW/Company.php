...
{
    protected static $companyEnSuffix = ['Inc', 'and Sons', 'LLC', 'Group', 'PLC', 'Ltd'];

    protected static $companyEnFormats = ['{{lastNameEn}} {{companyEnSuffix}}', '{{lastNameEn}}-{{lastNameEn}}', '{{lastNameEn}}, {{lastNameEn}} and {{lastNameEn}}'];

    protected static $formats = ['{{companyPrefix}}{{companyModifier}}', '{{companyPrefix}}{{companySuffix}}', '{{companyPrefix}}{{companyModifier}}{{CompanySuffix}}'];

    /**
     * @link http://zh.wikipedia.org/zh-tw/Category:%E5%8F%B0%E7%81%A3%E5%85%AC%E5%8F%B8%E5%88%97%E8%A1%A8
     */
    protected static $companyPrefix = ['乾坤', '亞神', '光譜', '典選', '凱基', '前衛花園', '創見', '友訊', '台達', '合勤', '喜瑪拉雅', '喬山', '多利安', '大國', '大宇', '太陽', '太陽動力', '宏碁', '宏達', '小白兔', '巨大', '巨室', '康師傅', '延伸', '弘煜', '彎的', '擎天', '新亞洲', '旺旺', '昱泉', '智冠', '未來', '松崗', '正新', '洧誠', '海蝶', '添翼創越', '滾石', '王品', '當然', '相信', '睛水', '研華', '福茂', '種子', '米樂士', '紅元素', '紅心辣椒', '統一', '美利達', '美妙', '美樂帝', '群石', '老鷹', '聯強', '芮河', '英特衛', '茂為', '華特', '華研', '華碩', '華義', '角頭', '訊連', '豐華', '豪客', '豪記', '貴族', '趨勢', '遊戲橘子', '野火樂集', '金革', '銀魚', '阿爾發', '風和日麗', '風潮', '風雲'];
    protected static $companyModifier = ['科技', '電腦', '國際', '電子', '娛樂', '音樂', '唱片', '證券', '集團', '企業', '機械', '工業', '文化', '汽車', '百貨', '酒店', '數位'];
    protected static $companySuffix = ['公司', '有限公司', '股份有限公司'];
    /**
