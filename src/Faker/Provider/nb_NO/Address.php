...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = ["Øvre", "Nedre", "Søndre", "Gamle", "Østre", "Vestre"];
    ...
    protected static $streetSuffixWord = ["sgate", "svei", "s Gate", "s Vei", "gata", "veien"];
