...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $maleNameFormats = ['{{namePrefix}}.{{firstNameMale}}'];

    protected static $femaleNameFormats = ['{{namePrefix}}.{{firstNameFemale}}'];
