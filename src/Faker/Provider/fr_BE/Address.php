...
class Address extends \Faker\Provider\fr_FR\Address
{
    ...
    protected static $streetSuffix = ['rue', 'avenue', 'boulevard', 'chemin', 'chaussée', 'impasse', 'place'];
