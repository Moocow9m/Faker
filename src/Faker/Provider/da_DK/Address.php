...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static $citySuffix = ['sted', 'bjerg', 'borg', 'rød', 'lund', 'by'];

    /**
     * @var array Danish street suffixes.
     */
    protected static $streetSuffix = ['vej', 'gade', 'skov', 'shaven'];

    /**
     * @var array Danish street word suffixes.
     */
    protected static $streetSuffixWord = ['Vej', 'Gade', 'Allé', 'Boulevard', 'Plads', 'Have'];
     ...
     */
    protected static $buildingLevel = ['st.', '%.', '%. sal.'];

    /**
     * @var array Danish building sides.
     */
    protected static $buildingSide = ['tv.', 'th.'];
     ...
     */
    protected static $streetNameFormats = ['{{lastName}}{{streetSuffix}}', '{{middleName}}{{streetSuffix}}', '{{lastName}} {{streetSuffixWord}}', '{{middleName}} {{streetSuffixWord}}'];

    /**
     * @var array Danish street's address formats.
     */
    protected static $streetAddressFormats = ['{{streetName}} {{buildingNumber}}', '{{streetName}} {{buildingNumber}}, {{buildingLevel}}', '{{streetName}} {{buildingNumber}}, {{buildingLevel}} {{buildingSide}}'];
