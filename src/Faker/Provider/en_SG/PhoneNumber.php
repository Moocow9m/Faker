...
{
    protected static $internationalCodePrefix = ['+65', '65'];

    protected static $zeroToEight = [0, 1, 2, 3, 4, 5, 6, 7, 8];

    protected static $oneToEight = [1, 2, 3, 4, 5, 6, 7, 8];

    protected static $mobileNumberFormats = ['{{internationalCodePrefix}}9{{zeroToEight}}## ####', '{{internationalCodePrefix}} 9{{zeroToEight}}## ####', '9{{zeroToEight}}## ####', '{{internationalCodePrefix}}8{{oneToEight}}## ####', '{{internationalCodePrefix}} 8{{oneToEight}}## ####', '8{{oneToEight}}## ####'];

    protected static $fixedLineNumberFormats = ['{{internationalCodePrefix}}6### ####', '{{internationalCodePrefix}} 6### ####', '6### ####'];

    // http://en.wikipedia.org/wiki/Telephone_numbers_in_Singapore#Numbering_plan
    protected static $formats = ['{{mobileNumber}}', '{{fixedLineNumber}}'];

    protected static $voipNumber = ['{{internationalCodePrefix}}3### ####', '{{internationalCodePrefix}} 3### ####', '3### ####'];

    protected static $tollFreeInternationalNumber = ['800 ### ####'];

    protected static $tollFreeLineNumber = ['1800 ### ####'];

    protected static $premiumPhoneNumber = ['1900 ### ####'];
