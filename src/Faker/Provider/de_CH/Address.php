...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetSuffixLong = ['Gasse', 'Platz', 'Ring', 'Strasse', 'Weg', 'Allee'];
    protected static $streetSuffixShort = ['gasse', 'platz', 'ring', 'strasse', 'str.', 'weg', 'allee'];
    ...
    protected static $streetNameFormats = ['{{lastName}}{{streetSuffixShort}}', '{{cityName}}{{streetSuffixShort}}', '{{firstName}}-{{lastName}}-{{streetSuffixLong}}'];
