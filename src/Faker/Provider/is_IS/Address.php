...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static $regionNames = ['Höfuðborgarsvæðið', 'Norðurland', 'Suðurland', 'Vesturland', 'Vestfirðir', 'Austurland', 'Suðurnes'];
     ...
     */
    protected static $streetNameFormats = ['{{streetPrefix}}{{streetSuffix}}', '{{streetPrefix}}{{streetSuffix}}', '{{firstNameMale}}{{streetSuffix}}', '{{firstNameFemale}}{{streetSuffix}}'];
