...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $stateAbbr = ['AP', 'AR', 'AS', 'BR', 'CG', 'GA', 'GJ', 'HR', 'HP', 'JK', 'JH', 'KA', 'KL', 'MP', 'MH', 'MN', 'ML', 'MZ', 'NL', 'OD', 'PB', 'RJ', 'SK', 'TN', 'TS', 'TR', 'UP', 'UK', 'WB', 'AN', 'CH', 'DN', 'DD', 'DL', 'LD', 'PY'];
    ...
    protected static $localityName = ['Aundh', 'Andheri', 'Borivali', 'Bandra', 'Chinchwad', 'Chandpole', 'Churchgate', 'Cyber City', 'Dadar', 'Deccan Gymkhana', 'Goregaon', 'Hadapsar', 'Harmada', 'Hinjewadi', 'Kormangala', 'Kharadi', 'Marathahalli', 'Model Town', 'Mansarovar', 'Malad', 'Sodala', 'Virar', 'Vikhroli', 'Yerwada', 'Yeshwanthpura'];
    protected static $areaSuffix = [' Nagar', 'Pur', 'Garh', 'Gunj', ' Chowk'];
    protected static $postcode = ['1#####', '2#####', '3#####', '4#####', '5#####'];
    protected static $localityFormats = ['{{firstName}}{{areaSuffix}}', '{{localityName}}'];
    protected static $addressFormats = ['{{streetAddress}} {{city}} - {{postcode}}'];
    protected static $societySuffix = ['Society', 'Apartments', 'Heights', 'Villas'];
    protected static $societyNameFormat = ['{{firstName}} {{societySuffix}}'];
    protected static $streetAddressFormats = ['{{buildingNumber}}, {{locality}},', '{{buildingNumber}}, {{societyName}}, {{locality}}'];
