...
class Address extends \Faker\Provider\Address
{
    ...
    private static $county = ['Abuja', 'Abia', 'Adamawa', 'Akwa Ibom', 'Anambra', 'Bauchi', 'Bayelsa', 'Benue', 'Borno', 'Cross River', 'Delta', 'Ebonyi', 'Edo', 'Ekiti', 'Enugu', 'Gombe', 'Imo', 'Jigawa', 'Kaduna', 'Kano', 'Katsina', 'Kebbi', 'Kogi', 'Kwara', 'Lagos', 'Nasarawa', 'Niger', 'Ogun', 'Ondo', 'Osun', 'Oyo', 'Plateau', 'Rivers', 'Sokoto', 'Taraba', 'Yobe', 'Zamfara'];
    private static $regions = ['Abakaliki', 'Abeokuta', 'Akure', 'Asaba', 'Awka', 'Bauchi', 'Calabar', 'City', 'Damaturu', 'Dutse', 'Ekiti', 'Enugu', 'Gombe', 'Gusau', 'Ibadan', 'Ikeja', 'Ilorin', 'Jalingo', 'Jos', 'Kaduna', 'Kano', 'Katsina', 'Kebbi', 'Lafia', 'Lokoja', 'Maiduguri', 'Makurdi', 'Minna', 'Oshogbo', 'Owerri', 'Port-Harcourt', 'Sokoto', 'Umuahia', 'Uyo', 'Yenagoa', 'Yola'];
