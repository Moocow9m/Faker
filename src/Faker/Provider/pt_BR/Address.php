...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $state = ['Acre', 'Alagoas', 'Amapá', 'Amazonas', 'Bahia', 'Ceará', 'Distrito Federal', 'Espírito Santo', 'Goiás', 'Maranhão', 'Mato Grosso', 'Mato Grosso do Sul', 'Minas Gerais', 'Pará', 'Paraíba', 'Paraná', 'Pernambuco', 'Piauí', 'Rio de Janeiro', 'Rio Grande do Norte', 'Rio Grande do Sul', 'Rondônia', 'Roraima', 'Santa Catarina', 'São Paulo', 'Sergipe', 'Tocantins'];
    protected static $stateAbbr = ['AC', 'AL', 'AP', 'AM', 'BA', 'CE', 'DF', 'ES', 'GO', 'MA', 'MT', 'MS', 'MG', 'PA', 'PB', 'PR', 'PE', 'PI', 'RJ', 'RN', 'RS', 'RO', 'RR', 'SC', 'SP', 'SE', 'TO'];
    protected static $region = ['Centro-Oeste', 'Nordeste', 'Norte', 'Sudeste', 'Sul'];
    protected static $regionAbbr = ['CO', 'N', 'NE', 'SE', 'S'];
    ...
    protected static $streetNameFormats = ['{{streetPrefix}} {{firstName}}', '{{streetPrefix}} {{lastName}}', '{{streetPrefix}} {{firstName}} {{lastName}}'];
    protected static $streetAddressFormats = ['{{streetName}}, {{buildingNumber}}', '{{streetName}}, {{buildingNumber}}. {{secondaryAddress}}'];
    protected static $addressFormats = ["{{postcode}}, {{streetAddress}}\n{{city}} - {{stateAbbr}}"];
    protected static $secondaryAddressFormats = ['Bloco A', 'Bloco B', 'Bloco C', 'Bc. # Ap. ##', 'Bc. ## Ap. ##', '#º Andar', '##º Andar', '###º Andar', 'Apto #', 'Apto ##', 'Apto ###', 'Apto ####', 'F', 'Fundos', 'Anexo'];
