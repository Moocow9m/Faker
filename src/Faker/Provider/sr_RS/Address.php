...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = ['Булевар'];

    protected static $street = ['Краља Милана', 'Цара Душана', 'Николе Тесле', 'Михајла Пупина', 'Николе Пашића'];
