...
final class PaymentTest extends TestCase
{
    ...
    {
        return [['Discover Card', '/^6011\d{12}$/'], ['Visa', '/^4\d{15}$/'], ['Visa Retired', '/^4\d{12}$/'], ['MasterCard', '/^(5[1-5]|2[2-7])\d{14}$/']];
    }
    ...
    public function testRandomCard()
    {
        ...
        $this->assertEquals(is_countable($cardDetails) ? count($cardDetails) : 0, 4);
